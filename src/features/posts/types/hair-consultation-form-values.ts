...
export const hairConsultationFormSchema = z.object({
  [HAIR_CONSULTATION_FORM_FIELD_NAME.HAIR_LENGTH]: z
    .enum(HAIR_CONSULTATION_HAIR_LENGTH_VALUES)
    .nullable(),
  [HAIR_CONSULTATION_FORM_FIELD_NAME.HAIR_CONCERNS]: z
    .array(z.enum(HAIR_CONSULTATION_CONCERN_OPTIONS))
    .min(1),
  [HAIR_CONSULTATION_FORM_FIELD_NAME.HAIR_TEXTURE]: z
    .enum(HAIR_CONSULTATION_HAIR_TEXTURE_VALUES)
    .nullable(),
  [HAIR_CONSULTATION_FORM_FIELD_NAME.SKIN_BRIGHTNESS]: z
    .enum(HAIR_CONSULTATION_SKIN_BRIGHTNESS_VALUES)
    .nullable(),
  [HAIR_CONSULTATION_FORM_FIELD_NAME.PERSONAL_COLOR]: z
    .enum(HAIR_CONSULTATION_PERSONAL_COLOR_VALUES)
    .nullable(),
