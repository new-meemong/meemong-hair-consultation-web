...
import ConsultingResponseCurrentState from '../ui/consulting-response/consulting-response-current-state';
import ConsultingResponsePriceAndComment from '../ui/consulting-response/consulting-response-price-and-comment';
import ConsultingResponseRecommendStyle from '../ui/consulting-response/consulting-response-recommend-style';
