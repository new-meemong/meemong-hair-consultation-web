...
export const DEFAULT_HAIR_CONSULTATION_FORM_VALUES: HairConsultationFormValues = {
  [HAIR_CONSULTATION_FORM_FIELD_NAME.HAIR_LENGTH]: null,
  [HAIR_CONSULTATION_FORM_FIELD_NAME.HAIR_CONCERNS]: [],
  [HAIR_CONSULTATION_FORM_FIELD_NAME.HAIR_TEXTURE]: null,
  [HAIR_CONSULTATION_FORM_FIELD_NAME.SKIN_BRIGHTNESS]: null,
  [HAIR_CONSULTATION_FORM_FIELD_NAME.PERSONAL_COLOR]: null,
