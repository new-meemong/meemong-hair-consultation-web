  ...
  'inline-flex items-center justify-center whitespace-nowrap rounded-2 transition-all disabled:pointer-events-none disabled:bg-label-disable',
  {
    variants: {
      ...
      theme: {
        ...
        white:
          'typo-body-2-medium bg-white hover:bg-alternative text-label-sub border border-border-default disabled:text-label-disable disabled:bg-white active:bg-alternative active:text-label-sub focus:bg-alternative focus:text-label-sub',
